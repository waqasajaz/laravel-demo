                    ...
                    <div class="discuss">
                        <div class="discuss__top">
                            ...
                            <div class="discuss__desc">
                                You can discuss the current offer that you’ve got. Change price, add a comments to a deal and check the compare the market situation for these type of deal.
                            </div>
                        </div>
                                    ...
                                    <div class="amount__row">
                                        <div class="amount__col">
                                            <div class="amount-field amount-field--focus">
                                                ...
                                                <input class="amount-field__input input-autosize" id="amount" type="text" value="1150">
