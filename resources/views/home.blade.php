                        ...
                        <div class="add-property__section">
                            ...
                            <div class="add-property__cols3bad">
                                ...
                                <div class="col">
                                    ...
                                    <div class="radio">
                                        <input class="js-toggle-add-property-fields" type="radio" id="r13"
                                               name="property_deal" data-type="rent">
                                        <label for="r13"><span></span>I’m renting</label>
                                    </div>
                                    <div class="radio">
                                        <input class="js-toggle-add-property-fields" type="radio" id="r14"
                                               name="property_deal" data-type="sell">
                                ...
                                <div class="add-property__row">
                                    ...
                                    <div class="add-property__amount">
                                        <div class="amount-field amount-field--full">
                                            <input class="amount-field__input js-format" id="amount" type="text"
                                                   value="1,150">
                            ...
                            <div class="add-property__only-rent">
                                <div class="add-property__cols2">
                                    <div class="col">
                                        ...
                                        <div class="add-property__amount">
                                            <div class="amount-field amount-field--full">
                                                <input class="amount-field__input js-format" id="amount2" type="text"
                                                       value="1,150">
                                                <div class="amount-field__currency">€</div>
                                            </div>
                            ...
                            <div class="add-property__cols2 add-property__cols2--small">
                                <div class="col">
                                    ...
                                    <div class="field-wrap-with-text">
                                        <input id="property_area" class="st-field st-field--sm" type="text"
                                               data-mask="000000">
                                        m<sup>2</sup>
                                    </div>
                                </div>
                                <div class="col">
                                    ...
                                    <input id="property_year" class="st-field st-field--sm" type="text"
                                           data-mask="0000">
                                </div>
                            </div>
                            <div class="add-property__row">
                                ...
                                <div class="add-property__features">
                                    <div class="add-property__features-col">
                                        ...
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f2">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-doorman.svg') }}">
                                                </div>
                                                Doorman
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f3">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-furniture.svg') }}">
                                                </div>
                                                Furnished
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f4">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-dishwasher.svg') }}">
                                                </div>
                                                Dishwasher
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f5">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-heating.svg') }}">
                                                </div>
                                                Heating
                                            </label>
                                        </div>
                                    ...
                                    <div class="add-property__features-col">
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f6">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-outdoor.svg') }}">
                                                </div>
                                                Outdoor space
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f7">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-gym.svg') }}">
                                                </div>
                                                Gym
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f8">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-pool.svg') }}">
                                                </div>
                                                Pool
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f9">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-pets.svg')}}">
                                                </div>
                                                Pets
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f10">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-dogs.svg') }}"></div>
                                                Dogs
                                            </label>
                                        </div>
                                    </div>
                                    <div class="add-property__features-col">
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f11">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-laundry.svg') }}"></div>
                                                Laundry
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f12">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-ac.svg') }}"></div>
                                                Central a/c
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                                            ...
                                            <label for="f13">
                                                <span></span>
                                                <div class="checkbox__icon"><img
                                                            src="{{ asset('frontend/assets/icons/icon-25x25-cat.svg') }}"></div>
                                                Cats
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox--small">
                            ...
                            <div class="add-property__row">
                                ...
                                <div class="add-property__files">
                                    <div class="file-input" id="file-list">
                                        ...
                                        <input id="file_images" multiple data-name="propertyImages"
                                               name="property_images[]" accept="image/*" type="file"
                                               class="js-file-multiple" data-filelist="#file-list">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="add-property__section">
                            ...
                            <div class="add-property__cols2">
                                ...
                                <div class="col">
                                    ...
                                    <input id="property_phone" data-mask="00 000-000-0000" class="st-field" type="tel"
                            ...
                            <div class="add-property__cols2">
                                ...
                                <div class="col">
                                    <label for="property_soon" class="st-label">How soon you want to sell the
                                        apartment</label>
                                    <select class="custom-select" name="property_soon" id="property_soon"
                                            style="width: 100%;">
